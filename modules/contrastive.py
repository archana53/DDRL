...
class ContrastiveLearning(pl.LightningModule):
    ...
    def __init__(self, in_channels, out_channels, lr, temperature, weight_decay, timestep, scales, scale_direction,
                 max_epochs=500, hidden_channels1=256, hidden_channels2=128):
        super().__init__()
...
if __name__ == '__main__':
    celeb_data = CelebAHQDataset(root_dir="/home/suyash/Gatech/DDRL/modules/data/contrastive",
